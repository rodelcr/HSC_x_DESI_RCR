...
if not os.path.exists('qsopar.fits'):
    ...
    (4340, 'Hg', 4300, 4400, 'Hg_br',     1, 0.0, 0.0, 1e10, 5e-3, 0.004,  0.05,   0.01, 0, 0, 0, 0.01 , 1),
    (4340, 'Hg', 4300, 4400, 'Hg_na',     1, 0.0, 0.0, 1e10, 1e-3, 2.3e-4, 0.00169, 0.001, 1, 1, 0, 0.002, 1),
